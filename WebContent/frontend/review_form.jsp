                                ...
                                <div class="ratting-form">
                                   <form id="reviewForm" action="submit_review" method="post">
                                        ...
                                        <div class="col-md-4">
                                           ...
                                           <div class="col-md-8 ">
                                                <div class="rating-form-style ">
                                                	<h3 >Review By Customer : ${loggedCustomer.fullname }</h3><br/>
                                                    <input name="headline" placeholder="Headline or summary for your review" type="text" required>
                                                    <textarea name="comment" placeholder="Write your review details..." required></textarea>
